...
plot_unemployment_rate <- unemployment_rate %>%
  ...
  scale_colour_manual(values = c("#1F78B4", "#E31A1C")) +
  theme_minimal() +
  annotate(geom = "label", x = as.Date("2014-07-01"), hjust = 0, y = 8.5, label = "Inauguratie Trump", colour = "#838B8B") +
...
# Vertrouwen van de wereld in President VS
